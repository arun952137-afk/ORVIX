...
export default function RegisterPage() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--void)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', marginBottom: 40, position: 'absolute', top: '10%' }}>
        ...
        <div style={{ fontFamily: 'var(--ser)', fontSize: 28, fontWeight: 300, color: 'var(--ivory)' }}>Begin your ascent.</div>
      </div>
      <SignUp
        appearance={{
          elements: {
